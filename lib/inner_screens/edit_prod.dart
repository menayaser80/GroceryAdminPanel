...
import 'package:grocery_admin/controllers/MenuController.dart';
import 'package:grocery_admin/screens/loading_manager.dart';
...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void initState() {
    ...
    percToShow = (100 -
        (_salePrice * 100) /
            double.parse(
                widget.price)) // WIll be the price inste   ad of 1.88
        .round()
        .toStringAsFixed(1) +
        '%';
    super.initState();
